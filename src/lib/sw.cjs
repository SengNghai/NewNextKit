import { PWA_VERSION } from '../utils/version'; // 导入版本号
// const PWA_VERSION = '2025.03.03.002858';

const CACHE_NAME = `my-cache-v${PWA_VERSION}`; // 使用版本号命名缓存
...
const checkForUpdates = async () => {
    if (PWA_VERSION !== '2025.03.02.161654') { // 设定版本号对比逻辑
